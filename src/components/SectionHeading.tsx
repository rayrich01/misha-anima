export const SectionHeading = () => {
  return (
    <div className="relative bg-white bg-[url('https://storage.builderall.com//franquias/2/40901/editor-html/11268562.jpg')] bg-origin-border bg-no-repeat bg-cover box-border caret-transparent h-auto min-h-[200px] w-full bg-center mx-auto md:h-[702px]">
      ...
      <div className="relative bg-transparent box-border caret-transparent h-full max-w-none min-h-[200px] w-full mx-auto px-[15px] md:max-w-[1140px]">
        ...
        <div className="relative box-border caret-transparent max-w-[500px] w-[424px] mx-auto p-[5px] left-0 top-0 md:absolute md:mx-0 md:p-0 md:left-[19px] md:top-[26px]">
          <div className="box-border caret-transparent">
            <span className="box-border caret-transparent hidden md:block">
              <h2 className="text-black text-[45px] font-medium box-border caret-transparent leading-[49.5px] mb-2 font-muli_black">
                <span className="text-white box-border caret-transparent">
                  <span className="text-3xl box-border caret-transparent leading-[33px]">
                    BEAUTIFUL MURALS!
                  </span>
                </span>
              </h2>
